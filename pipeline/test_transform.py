...
class TestGetCountry:
    ...
    def test_get_country_valid(self) -> None:
        """Test valid country"""
        country_code = "BR"
...
class TestTransformData:
    ...
    def test_tranform_data_name(self, plant_data: list[dict]) -> None:
        """Test valid name"""
        data = transform_data(plant_data)[0]
        assert data["first_name"], data["last_name"] == "Carl Linnaeus"

    def test_tranform_data_valid(self, plant_data: list[dict]) -> None:
    ...
    def test_tranform_data_invalid(self, plant_data: list[dict]) -> None:
